...
/datum/statpack/agile/swift
	...
	stat_array = list(STAT_SPEED = 2, STAT_CONSTITUTION = 1, STAT_STRENGTH = -1)
...
/datum/statpack/agile/hardy
	...
	stat_array = list(STAT_CONSTITUTION = 2, STAT_STRENGTH = -1, STAT_SPEED = -1)

/datum/statpack/agile/tricky
	name = "Tricky"
	desc = "Swift feet with a mind to match and a tiny sliver of the Ten's own luck... or not."
	stat_array = list(STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 1, STAT_SPEED = 1, STAT_FORTUNE = 1, STAT_CONSTITUTION = -1, STAT_STRENGTH = -1)
...
/datum/statpack/agile/thug
	...
	stat_array = list(STAT_STRENGTH = 2, STAT_PERCEPTION = 1, STAT_FORTUNE = list(0, 1), STAT_CONSTITUTION = -1, STAT_SPEED = -1)
...
/datum/statpack/agile/deft
	...
	stat_array = list(STAT_PERCEPTION = 1, STAT_SPEED = 1, STAT_CONSTITUTION = 1, STAT_STRENGTH = -1)
