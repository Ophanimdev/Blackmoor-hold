...
/datum/statpack/mental/scholarly
	...
	stat_array =  list(STAT_INTELLIGENCE = 2, STAT_PERCEPTION = 1, STAT_STRENGTH = -1, STAT_CONSTITUTION = -1)
...
/datum/statpack/mental/faithdriven
	...
	stat_array = list(STAT_INTELLIGENCE = 1, STAT_CONSTITUTION = 1, STAT_PERCEPTION = -2)

/datum/statpack/mental/zealous
	name = "Zealous"
	desc = "Faith in something drives your body and mind to match what neither can see."
	stat_array = list(STAT_STRENGTH = 1, STAT_INTELLIGENCE = 1, STAT_CONSTITUTION = 1, STAT_PERCEPTION = -1, STAT_SPEED = -1)

/datum/statpack/mental/augury
	name = "Foresighted"
	desc = "You see what is and what will sometimes be."
	stat_array = list(STAT_PERCEPTION = 2, STAT_INTELLIGENCE = 1, STAT_STRENGTH = -1, STAT_CONSTITUTION = -1)
...
/datum/statpack/mental/aware
	...
	stat_array = list(STAT_PERCEPTION = 2, STAT_SPEED = 1, STAT_CONSTITUTION = -1)
...
/datum/statpack/mental/precise
	...
	stat_array = list(STAT_PERCEPTION = 2, STAT_STRENGTH = 1, STAT_CONSTITUTION = -1)

/datum/statpack/mental/diligent
	name = "Diligent"
	desc = "You take your time, but you have a lot of it to spare."
	stat_array =  list(STAT_INTELLIGENCE = 2, STAT_CONSTITUTION = 1, STAT_SPEED = -1)
